...
import { useUpdateProfileMutation,  useGetagentQuery } from "@/Redux/features/auth/user.api";
import { toast } from "sonner";

export default function Profile() {
  // ✅ Overview API থেকে ডাটা লোড
  const { data, isLoading, refetch } = useGetagentQuery(undefined);
  const [updateProfile] = useUpdateProfileMutation();
console.log(data,"data")
  const user = data?.data?.agent || {};
